    ...
    <header class="header">
        ...
        <div class="search-bar">
            <div class="search-bar__group search-bar__group_main">
                ...
                <input type="text" class="search-bar__input" placeholder="Найти ресторан, блюдо или товар">
            </div>
            <div id="address-picker-placeholder" class="search-bar__group search-bar__group_address"></div>
        </div>

        <div class="header__controls">
            <button id="support-btn" class="support-btn" data-support-url="https://example.com">
                <div id="support-btn__support-icon">
                    <svg width="33" height="24" viewBox="0 0 33 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1.79287 22.0948L0.126675 21.5498C0.0076213 21.7961 -0.0284097 22.0642 0.0223794 22.3259C0.0731685 22.5876 0.208897 22.8332 0.415256 23.0368C0.621615 23.2404 0.890961 23.3944 1.1949 23.4827C1.49884 23.571 1.82612 23.5902 2.14223 23.5383L1.79287 22.0948ZM10.021 20.965L10.75 19.7832L10.2241 19.2711L8.75 20.2832L10.021 20.965ZM4.44412 15.996L5.75 16.423L6.25 15.7832L5.75 15.2832L4.44412 15.996ZM29.25 11.7832C29.25 16.5645 23.5555 21.2832 16.9677 21.2832V23.5678C25.2826 23.5678 32.2501 18.3917 32.2501 11.7839L29.25 11.7832ZM4.70243 11.7839C4.70243 7.00258 10.3836 2.5951 16.9695 2.5951V0C8.6547 0 1.68537 5.17607 1.68537 11.7839H4.70243ZM16.9695 2.5951C23.5555 2.5951 29.25 7.00189 29.25 11.7832L32.2501 11.7839C32.2501 5.17607 25.2844 0 16.9695 0V2.5951ZM16.9677 21.2832C14.8089 21.2832 12.4753 20.5447 10.75 19.7832L9.37493 22.0123C11.71 23.0415 14.3183 23.5761 16.9677 23.5678V21.2832ZM2.14223 23.5383L10.5735 22.1596L10.021 20.965L8.75 20.2832L1.25 21.2832L2.14223 23.5398V23.5383ZM5.75 15.2832C5.06794 14.1501 4.70514 13.0481 4.70243 11.7839H1.68537C1.68537 13.5515 2.1906 15.2277 3.09357 16.7331L5.75 15.2832ZM3.03803 15.5356L0.126675 21.5513L2.75 22.7832L5.75 16.423L3.03624 15.5356H3.03803Z" fill="#FFC1C1"/>
                    </svg>
                </div>
            </button>
            {{? it.user }}
