                    ...
                    fallback={
                        <>
                            <div class="auth-guest-controls">
                                <button
                                    class="button button_header-login"
                                    onClick={handleLoginClick}
                                >
                                    Войти
                                </button>
                                <button
                                    class="button button_header-reg"
