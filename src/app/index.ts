...
/**
 * Инициализирует приложение и отрисовывает первый роут.
 *
 ...
 * сервис-воркера для офлайн-кэша. После этого монтируется баннер сетевого
 * статуса. В конце роутер отрисовывает страницу, соответствующую текущему
 * `window.location.pathname`.
 *
 * @returns Промис, разрешающийся после монтирования первой страницы.
 */
